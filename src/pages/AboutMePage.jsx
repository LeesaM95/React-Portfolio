...
export default function About() {
    return(
        ...
        <Container>
            <Row>
                <Col xs={6} md={6}>
                    <h2 style={{ marginBottom: 30, marginLeft: 450, marginTop: 180, fontSize: 40 }}>About Me</h2>
                    <hr style={{ marginLeft: 450, width: 450 }}></hr>
                    <Image src="https://images2.imgbox.com/eb/af/xTykfPC8_o.png" height={400} width={400} style={{ marginTop: -80 }}></Image>
                </Col>



                <Col md={{ span: 8, offset: 4 }}>
                    <Stack direction="vertical" gap={2} style={{ marginTop: -250 }}>
                        <p>Hello! My name is Leesa. I was born and raised in a small city in central Massachusetts and have been living in Eastern Pennsylvania since 2020.
